...
def plot_shapley_values(dataset, shapley_values, sortby="value", title=None, cmap=None, ylim=None):
...
class GaussianDataset(Dataset):
  ...
  def _plot(self, axis, plot_dataset, plot_gaussians, model, shapley_values, title=None, ignore=[], ignore_sv=False):
    # plot dataset
    if plot_dataset:
  ...
  def plot(self, dataset=True, gaussians=True, model=None, shapley_values=None, title=None, ignore=[], ignore_sv=False):
    fig, axis = plt.subplots(figsize=(4, 4), constrained_layout=True)
    self._plot(axis, dataset, gaussians, model, shapley_values, title=title, ignore=ignore, ignore_sv=ignore_sv)
    return fig
  
  def plot_splitted(self, dataset=True, gaussians=True, model=None, shapley_values=None, title=None, ignore=[]):
    ...
    self._plot(axes[0], dataset, gaussians, model, shapley_values, title="{} (low25)".format(title), ignore=mid50 + top25, ignore_sv=False)
    self._plot(axes[1], dataset, gaussians, model, shapley_values, title="{} (mid50)".format(title), ignore=low25 + top25, ignore_sv=False)
    self._plot(axes[2], dataset, gaussians, model, shapley_values, title="{} (top25)".format(title), ignore=low25 + mid50, ignore_sv=False)
...
class GaussianExperimentB(GaussianExperimentA):
  ...
  def run(self, save_results=True):
    ...
    for top in self.without_top:
      ...
      super().run(ignore=ignore_indices, memo=True)
...
# !rm -r /content/experimentB1
# !rm -r /content/experimentB1_replot
# !unzip -u -q "/content/drive/MyDrive/Eigene Dateien/results.zip" -d "/content"

# !rm experimentB1_replot.zip
# !zip experimentB1_replot.zip /content/experimentB1_replot/*/*/*

# INPUT_DIR = "/content/experimentB1"
# OUTPUT_DIR = "/content/experimentB1_replot"

# DIRLIST = sorted([f2.path for f1 in os.scandir(INPUT_DIR) if f1.is_dir() for f2 in os.scandir(f1.path) if f2.is_dir()])

# def load_experimentB1(folder):
...
# def replot_dataset_experimentB1():
...
#     config, shapley_values, train_dataset, test_dataset = load_experimentB1(folder)
...
# def replot_shapley_values_experimentB1():
...
# replot_dataset_experimentB1()
# replot_shapley_values_experimentB1()
...
# !rm -r /content/experimentA3
# !rm -r /content/experimentA3_replot
# !unzip -u -q "/content/drive/MyDrive/Eigene Dateien/results.zip" -d "/content"

# !rm experimentA3_replot.zip
# !zip experimentA3_replot.zip /content/experimentA3_replot/*/*/*

# INPUT_DIR = "/content/experimentA3"
# OUTPUT_DIR = "/content/experimentA3_replot"
...
# !rm -r /content/experimentA2
# !rm -r /content/experimentA2_replot
# !unzip -u -q "/content/drive/MyDrive/Eigene Dateien/results.zip" -d "/content"

# !rm experimentA2_replot.zip
# !zip experimentA2_replot.zip /content/experimentA2_replot/*/*/*

# INPUT_DIR = "/content/experimentA2"
# OUTPUT_DIR = "/content/experimentA2_replot"
...
# def replot_dataset_experimentA2():
#   print("Replotting dataset")
...
#     # load experiment folder
#     config, shapley_values, train_dataset, test_dataset = load_experimentA2(folder)
#     experiment_name = config["experiment"].split("/")[1]
...
# def replot_shapley_values_experimentA2():
#   print("Replotting Shapley values")
...
# replot_dataset_experimentA2()
# replot_shapley_values_experimentA2()
...
# !rm -r /content/experimentA1
# !rm -r /content/experimentA1_replot
# !unzip -u -q "/content/drive/MyDrive/Eigene Dateien/results.zip" -d "/content"

# !rm experimentA1_replot.zip
# !zip experimentA1_replot.zip /content/experimentA1_replot/*/*/*

# INPUT_DIR = "/content/experimentA1"
# OUTPUT_DIR = "/content/experimentA1_replot"
...
# def replot_dataset_experimentA1():
#   print("Replotting dataset")
...
#     # load experiment folder
#     config, shapley_values, train_dataset, test_dataset = load_experimentA1(folder)
#     experiment_name = config["experiment"].split("/")[1]
#     model_name = experiment_name.split("_", 1)[1].rsplit("_", 1)[0]
...
# def replot_shapley_values_experimentA1():
#   print("Replotting Shapley values")
...
# replot_dataset_experimentA1()
# replot_shapley_values_experimentA1()
