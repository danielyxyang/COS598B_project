...
class GaussianExperiment():
  ...
  def run(self, save_results=True):
    ...
    if save_results:
      ...
      folder = os.path.join("results", self.experiment_type, self.experiment_name)
...
def get_experiments(e, test_run=False):
  return [
      GaussianExperiment(
          model_constructor,
...
experiments = [
    *get_experiments(experiments_dev),
    # *get_experiments(experiments1, test_run=False),
    # *get_experiments(experiments2, test_run=DEV),
]
