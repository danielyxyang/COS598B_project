...
class GaussianExperimentB(GaussianExperimentA):
  def __init__(self, *args, without_top=[], without_bottom=[], **kwargs):
  ...
  def get_experiment_batch(config, test_run=False):
    return [
        GaussianExperimentB(
            ...
            without_bottom=config["without_bottom"],
            num_permutations=params["num_permutations"] if not test_run or params["num_permutations"] is None else 10,
            seed=seed,
...
# !rm -r /content/results/experimentC1_replot
...
# def replot_dataset_experimentC1():
...
#     config, shapley_values, train_dataset, test_dataset = load_experimentC1(folder)
...
# def replot_shapley_values_experimentC1():
...
# replot_dataset_experimentC1()
# replot_shapley_values_experimentC1()
...
# !rm -r /content/results/experimentB1_replot
# !unzip -u -q "/content/drive/MyDrive/Eigene Dateien/results.zip" -d "/content"
...
# !rm -r /content/results/experimentA3_replot
# !unzip -u -q "/content/drive/MyDrive/Eigene Dateien/results.zip" -d "/content"
...
# !rm -r /content/results/experimentA2
...
# !rm -r /content/results/experimentA1
